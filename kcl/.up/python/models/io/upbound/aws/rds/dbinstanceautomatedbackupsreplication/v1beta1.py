...
#   filename:  workdir/rds_aws_upbound_io_v1beta1_dbinstanceautomatedbackupsreplication.yaml
...
class SourceDbInstanceArnRef(BaseModel):
    name: str
    """
    Name of the referenced object.
    """
...
class SourceDbInstanceArnSelector(BaseModel):
    matchControllerRef: Optional[bool] = None
    """
    MatchControllerRef ensures an object with the same controller reference
    as the selecting object is selected.
...
class ForProvider(BaseModel):
    ...
    """
    sourceDbInstanceArn: Optional[str] = None
    """
    The Amazon Resource Name (ARN) of the source DB instance for the replicated automated backups, for example, arn:aws:rds:us-west-2:123456789012:db:mydatabase.
    """
    sourceDbInstanceArnRef: Optional[SourceDbInstanceArnRef] = None
    """
    Reference to a Instance in rds to populate sourceDbInstanceArn.
    """
    sourceDbInstanceArnSelector: Optional[SourceDbInstanceArnSelector] = None
    """
...
class DBInstanceAutomatedBackupsReplicationList(BaseModel):
    ...
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[DBInstanceAutomatedBackupsReplication]
    """
    List of dbinstanceautomatedbackupsreplications. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: Optional[str] = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
