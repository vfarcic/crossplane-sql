...
#   filename:  workdir/ec2_aws_upbound_io_v1beta1_managedprefixlist.yaml
...
class EntryItem(BaseModel):
    ...
    """
    cidrRef: Optional[CidrRef] = None
    """
    Reference to a VPCIPv4CidrBlockAssociation in ec2 to populate cidr.
    """
    cidrSelector: Optional[CidrSelector] = None
    """
...
class ForProvider(BaseModel):
    ...
    """
    maxEntries: Optional[float] = None
    """
...
class EntryItemModel(BaseModel):
    cidr: Optional[str] = None
    """
    CIDR block of this entry.
    """
...
class AtProvider(BaseModel):
    ...
    """
    entry: Optional[List[EntryItemModel]] = None
    """
    Configuration block for prefix list entry. Detailed below. Different entries may have overlapping CIDR blocks, but a particular CIDR should not be duplicated.
    """
...
class ManagedPrefixListList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[ManagedPrefixList]
    """
    List of managedprefixlists. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: Optional[str] = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
