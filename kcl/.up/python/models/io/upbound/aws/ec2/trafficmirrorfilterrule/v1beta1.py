...
#   filename:  workdir/ec2_aws_upbound_io_v1beta1_trafficmirrorfilterrule.yaml
...
class DestinationPortRangeItem(BaseModel):
...
class SourcePortRangeItem(BaseModel):
    fromPort: Optional[float] = None
    """
    Starting port of the range
    """
...
class TrafficMirrorFilterIdRef(BaseModel):
    name: str
    """
...
class TrafficMirrorFilterIdSelector(BaseModel):
...
class ForProvider(BaseModel):
    ...
    """
    destinationPortRange: Optional[List[DestinationPortRangeItem]] = None
    """
    ...
    """
    sourcePortRange: Optional[List[SourcePortRangeItem]] = None
    """
    ...
    """
    trafficMirrorFilterIdRef: Optional[TrafficMirrorFilterIdRef] = None
    """
    Reference to a TrafficMirrorFilter in ec2 to populate trafficMirrorFilterId.
    """
    trafficMirrorFilterIdSelector: Optional[TrafficMirrorFilterIdSelector] = None
    """
...
class TrafficMirrorFilterRuleList(BaseModel):
    ...
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[TrafficMirrorFilterRule]
    """
    List of trafficmirrorfilterrules. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: Optional[str] = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
