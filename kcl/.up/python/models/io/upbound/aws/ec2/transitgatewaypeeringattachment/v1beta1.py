...
#   filename:  workdir/ec2_aws_upbound_io_v1beta1_transitgatewaypeeringattachment.yaml
...
class Options(BaseModel):
    dynamicRouting: Optional[str] = None
    """
...
class PeerTransitGatewayIdRef(BaseModel):
    name: str
    """
...
class PeerTransitGatewayIdSelector(BaseModel):
...
class ForProvider(BaseModel):
    ...
    """
    peerAccountId: Optional[str] = None
    """
    ...
    """
    peerTransitGatewayIdRef: Optional[PeerTransitGatewayIdRef] = None
    """
    Reference to a TransitGateway in ec2 to populate peerTransitGatewayId.
    """
    peerTransitGatewayIdSelector: Optional[PeerTransitGatewayIdSelector] = None
    """
...
class TransitGatewayPeeringAttachmentList(BaseModel):
    ...
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[TransitGatewayPeeringAttachment]
    """
    List of transitgatewaypeeringattachments. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: Optional[str] = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
