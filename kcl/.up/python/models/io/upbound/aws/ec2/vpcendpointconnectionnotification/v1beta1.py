...
#   filename:  workdir/ec2_aws_upbound_io_v1beta1_vpcendpointconnectionnotification.yaml
...
class ConnectionNotificationArnRef(BaseModel):
    name: str
    """
...
class ConnectionNotificationArnSelector(BaseModel):
...
class VpcEndpointServiceIdRef(BaseModel):
    name: str
    """
    Name of the referenced object.
    """
...
class VpcEndpointServiceIdSelector(BaseModel):
    matchControllerRef: Optional[bool] = None
    """
    MatchControllerRef ensures an object with the same controller reference
    as the selecting object is selected.
...
class ForProvider(BaseModel):
    ...
    """
    connectionNotificationArnRef: Optional[ConnectionNotificationArnRef] = None
    """
    Reference to a Topic in sns to populate connectionNotificationArn.
    """
    connectionNotificationArnSelector: Optional[ConnectionNotificationArnSelector] = (
        None
    )
    """
    ...
    """
    vpcEndpointServiceId: Optional[str] = None
    """
    The ID of the VPC Endpoint Service to receive notifications for.
    """
    vpcEndpointServiceIdRef: Optional[VpcEndpointServiceIdRef] = None
    """
    Reference to a VPCEndpointService in ec2 to populate vpcEndpointServiceId.
    """
    vpcEndpointServiceIdSelector: Optional[VpcEndpointServiceIdSelector] = None
    """
...
class VPCEndpointConnectionNotificationList(BaseModel):
    apiVersion: Optional[str] = None
    """
    APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
    """
    items: List[VPCEndpointConnectionNotification]
    """
    List of vpcendpointconnectionnotifications. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: Optional[str] = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
