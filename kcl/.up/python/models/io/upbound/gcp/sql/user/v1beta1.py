...
#   filename:  workdir/sql_gcp_upbound_io_v1beta1_user.yaml
...
class PasswordPolicyItem(BaseModel):
    allowedFailedAttempts: Optional[float] = None
    """
    Number of failed attempts allowed before the user get locked.
    """
    enableFailedAttemptsCheck: Optional[bool] = None
    """
    If true, the check that will lock user after too many failed login attempts will be enabled.
    """
    enablePasswordVerification: Optional[bool] = None
    """
    If true, the user must specify the current password before changing the password. This flag is supported only for MySQL.
    """
    passwordExpirationDuration: Optional[str] = None
    """
...
class ForProvider(BaseModel):
    ...
    """
    passwordPolicy: Optional[List[PasswordPolicyItem]] = None
...
class PasswordPolicyItemModel(BaseModel):
    allowedFailedAttempts: Optional[float] = None
    """
    Number of failed attempts allowed before the user get locked.
    """
...
class SqlServerUserDetail(BaseModel):
    ...
    serverRoles: Optional[List[str]] = None
...
class AtProvider(BaseModel):
    ...
    forces a new resource to be created.
    """
    passwordPolicy: Optional[List[PasswordPolicyItemModel]] = None
    project: Optional[str] = None
    """
    The ID of the project in which the resource belongs. If it
    is not provided, the provider project is used.
